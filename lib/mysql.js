...
let users =
    `create table if not exists users(
     ...
     avator VARCHAR(10000) NOT NULL DEFAULT 'https://dss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3256100974,305075936&fm=26&gp=0.jpg' COMMENT '头像',
     moment VARCHAR(100) NOT NULL COMMENT '注册时间',
     friendnum INT NOT NULL DEFAULT 0 COMMENT '好友数量',
     ordernum INT NOT NULL DEFAULT 0 COMMENT '订单数量',
     PRIMARY KEY ( id )
    );`
